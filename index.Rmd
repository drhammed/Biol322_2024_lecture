...
--
_**Which of the four models defined above do you think would not violate any assumptions?**_
...
- Compares the sample quantiles to the quantiles of a theoretical normal distribution
...
mod_fit <- lm(PropBlack ~ Age , data = Lion)

plot(PropBlack ~ Age, data = Lion, col = "blue", pch = 20, main = "Prop. of Black vs Age (in Years)")
...
From the Shapiro normality test, the P-value > 0.05 (and at any conventional level of significance), we have strong evidence to conclude that this data comes from a normal population, as such **normality assumption** is met. 
